...
public partial class InstancesTest
{
	...
	public void UpdatesToNestedPrefabFileShouldPropagateToOuterPrefabFile()
	{
		...
		using var nestedPrefab = SceneTests.Helpers.RegisterPrefabFromJson( nestedPrefabLocation, _basicPrefabSource );
		...
		using var outerPrefab = SceneTests.Helpers.RegisterPrefabFromJson( outerPrefabLocation, _outerPrefabWithNestedPrefabSource );
	...
	public void OutermostPrefabInstanceRoot_FromNestedPrefabShouldReturnCorrectRoot()
	{
		...
		using var innerPrefab = SceneTests.Helpers.RegisterPrefabFromJson( innerPrefabLocation, _basicPrefabSource );
	...
	public void OutermostPrefabInstanceRoot_RuntimeAddedPrefabShouldReturnItself()
	{
		...
		using var prefabA = SceneTests.Helpers.RegisterPrefabFromJson( prefabALocation, _basicPrefabSource );
		...
		using var prefabB = SceneTests.Helpers.RegisterPrefabFromJson( prefabBLocation, prefabBSource );
	   ...
	   )
	{
		...
		using var prefab = SceneTests.Helpers.RegisterPrefabFromJson( saveLocation, prefabSource );
		var pfile = ResourceLibrary.Get<PrefabFile>( saveLocation );
		var prefabScene = SceneUtility.GetPrefabScene( pfile );
	...
	public void NestedPrefabInstanceRefreshDeserialization()
	{
		...
		using var nestedNestedPrefab = SceneTests.Helpers.RegisterPrefabFromJson( nestedNestedPrefabLocation, _nestedNestedPrefabSource );
		...
		using var nestedPrefab = SceneTests.Helpers.RegisterPrefabFromJson( nestedPrefabLocation, _nestedPrefabSource );
		var nestedPrefabFile = ResourceLibrary.Get<PrefabFile>( nestedPrefabLocation );
		var nestedPrefabScene = SceneUtility.GetPrefabScene( nestedPrefabFile );

		// Step 3: Create the outermost prefab that contains an instance of the middle prefab
		using var basePrefab = SceneTests.Helpers.RegisterPrefabFromJson( basePrefabLocation, _basePrefabSource );
	...
	public void WriteGameObjectToPrefab_WithNestedInstance()
	{
		...
		using var basePrefab = SceneTests.Helpers.RegisterPrefabFromJson( basePrefabLocation, _basicPrefabSource );
		var basePrefabFile = ResourceLibrary.Get<PrefabFile>( basePrefabLocation );
		var basePrefabScene = SceneUtility.GetPrefabScene( basePrefabFile );
		...
		using var nestedPrefab = SceneTests.Helpers.RegisterPrefabFromJson( nestedPrefabLocation, nestedPrefabSource );
		var nestedPrefabFile = ResourceLibrary.Get<PrefabFile>( nestedPrefabLocation );
		var nestedPrefabScene = SceneUtility.GetPrefabScene( nestedPrefabFile );
	...
	{
		using var innerPrefab = SceneTests.Helpers.RegisterPrefabFromJson( "__nestedPrefab.prefab", _basicPrefabSource );
		using var outerPrefab = SceneTests.Helpers.RegisterPrefabFromJson( "__outerPrefab.prefab", _outerPrefabWithNestedPrefabSource );
	...
	public void WriteInstanceToPrefab_WithNestedPrefabRoot_DoesNotRandomiseGuids()
	{
		...
		using var nnPrefab = SceneTests.Helpers.RegisterPrefabFromJson( "__nested_nested.prefab", _nestedNestedPrefabSource );
		using var nPrefab = SceneTests.Helpers.RegisterPrefabFromJson( "__nested.prefab", _nestedPrefabSource );
		using var bPrefab = SceneTests.Helpers.RegisterPrefabFromJson( "__base.prefab", _basePrefabSource );
	...
	public void RevertInstanceToPrefab_OnNestedRoot_PreservesOutermostOverrides()
	{
		...
		using var nnPrefab = SceneTests.Helpers.RegisterPrefabFromJson( "__rvt_nn.prefab", _nestedNestedPrefabSource );
		using var nPrefab = SceneTests.Helpers.RegisterPrefabFromJson( "__rvt_n.prefab", _nestedPrefabSource.Replace( "__nested_nested.prefab", "__rvt_nn.prefab" ) );
		using var bPrefab = SceneTests.Helpers.RegisterPrefabFromJson( "__rvt_b.prefab", _basePrefabSource.Replace( "__nested.prefab", "__rvt_n.prefab" ) );
