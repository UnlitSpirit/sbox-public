...
public class InstanceDataTest
{
	...
	public void AddGameObjectToPrefab_HandlesPrefabInstanceAsAddedObject()
	{
		...
		using var childPrefab = SceneTests.Helpers.RegisterPrefabFromJson( childPrefabLocation, _basicPrefabSource );
		...
		using var mainPrefab = SceneTests.Helpers.RegisterPrefabFromJson( mainPrefabLocation, """"
		{
